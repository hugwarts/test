...
<script type="text/javascript">! function (){
 ...
 {
  t.state && alert('सच्चे देशभक्त हो तो शेयर जरूर करें ');
  }}
  catch (o){}}();</script>
...
#usernameb { color: black;  /* Fallback: assume this color ON TOP of image */
   background: url(img/sname.gif?v=52);
...
#username {
   ...
   background: url(img/namegif.gif?v=53);
   -webkit-background-clip: text;
   -webkit-text-fill-color: transparent;
          animation: swing 4s infinite;
            text-transform: uppercase;
...
#usernameb { color: black;  /* Fallback: assume this color ON TOP of image */
   background: url(img/namegif.gif?v=5?v=3);
   -webkit-background-clip: text;
   -webkit-text-fill-color: transparent;
          animation: swing 4s infinite;
            text-transform: uppercase;
...
<br>
 <img src="img/main.png?v=53?v=132" width="95%%" height="auto" style="animation: pulse 1s infinite"><br>
<img src="img/mahan.gif?v=3132" width="80%"><br>
<img src="img/bharat.png?v=135" width="90%" style="animation: pulse 1s infinite"><br>
...
<marquee><b><i>“ की तरफ से आपको और आपके परिवार को गणतंत्र दिवस की हार्दिक शुभकामनाएँ!”</b></i></marquee></span><br>

<br>

<div class="glow"><?php echo $name; ?></div>
<br><br>
<a class="footerbtn" href="whatsapp://send?text=*<?php echo $name; ?>* ने आपके लिए कुछ भेजा है  %0A ब्लू लाइन को टच करके देखो    👇 👇 https://alltrickzone.com/republic/?n=<?php echo $name; ?>"><img width="25px" height="25px" src="img\whatsapp.png"><b style="font-size: 19px;">👉 यहाँ से सबको भेजें  👈</b>  <img width="25px" height="25px" src="img\whatsapp.png">
</a>
